    ...
    <div className={backgroundClass}>
      <div className="relative flex h-auto min-h-screen w-full flex-col justify-between group/design-root overflow-x-hidden text-foreground">
        <main className="flex flex-col items-center justify-center flex-grow px-6 pt-8 text-center">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-foreground">Gebeta</h1>
          <p className="mt-3 text-lg text-muted-foreground max-w-xs mx-auto">The ancient game of strategy and skill, reimagined.</p>
        ...
        <footer className="sticky bottom-0 bg-card/80 backdrop-blur-lg border-t border-border shadow-t-sm">
          <nav className="flex justify-around items-center px-4 py-2">
            <Link className="flex flex-col items-center justify-center gap-1 p-2 rounded-lg text-primary" to="/">
            ...
            <Link className="flex flex-col items-center justify-center gap-1 p-2 rounded-lg text-muted-foreground hover:text-primary transition-colors" to="/settings">
